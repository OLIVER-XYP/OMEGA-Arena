...
struct RuntimeConfig {
    EngineBackendMode engine_backend{EngineBackendMode::Cpu};
    unsigned long gpu_batch_size{1};
    bool skip_inspiration_phase{false};
    bool skip_regen_phase{false};
    bool skip_end_economy_phases{false};
};
